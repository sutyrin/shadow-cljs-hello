...
var SHADOW_IMPORT_PATH = __dirname + '/app/cljs-runtime';
if (__dirname == '.') { SHADOW_IMPORT_PATH = "/home/pavel/dev/reddit/flashcards-demo/out/app/cljs-runtime"; }
global.$CLJS = global;
...
SHADOW_IMPORT("flashcards_demo.core.js");
